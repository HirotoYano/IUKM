...
from src.codebase.dataprocessor.data_loder import data_loder
from src.codebase.dataprocessor.get_info import get_file_name
from src.codebase.dataprocessor.make_dir import make_dir
from src.codebase.dataprocessor.make_speaker_utterance_data import (
    make_assembly_data,
    make_digest_data,
)
from src.codebase.dataprocessor.save_data import save_csv
...
def main():
    ...
    for file in files:
        ...
        make_dir_path = (
            interim_data_path + "/adjacency_pair/" + os.path.splitext(file)[0]
        )
